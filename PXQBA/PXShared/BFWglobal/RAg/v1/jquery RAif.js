...
//CLASS PROMPT VERSION
			if (RA_CtrlWin.RA.CurrentUser != null) {
				...
				if (RA_CtrlWin.RA.RAif.updated && RA_CtrlWin.RA.CurrentUser.ClassPrompt==0) {
					RA_DrawPage();
					$('#RA_quizclassprompt_1').css('display','none');
					$('#RA_quizclassprompt_2').css('display','none');
					$('#RA_quizclassprompt_3').css('display','none');
					$('#RA_quizclassprompt_4').css('display','none');
					$('#RA_quizclassprompt_5').css('display','block');
					setTimeout('RA_QuizClassPromptedYes()',200);
					RAif_Resize();
//window.self.focus();
					...
					$('#RA_quizclassprompt_1').css('display','none');
					$('#RA_quizclassprompt_2').css('display','none');
					$('#RA_quizclassprompt_3').css('display','block');
					$('#RA_quizclassprompt_4').css('display','none');
				} else if (UserClassesCt==1) {
					...
					RA_DrawPage();
					$('#RA_quizclassprompt_1').css('display','block');
					$('#RA_quizclassprompt_2').css('display','none');
					$('#RA_quizclassprompt_3').css('display','none');
					$('#RA_quizclassprompt_4').css('display','none');
				}
...
function RA_goLogin () {
	...
	RA_CtrlWin.RA.RAif.vars['Password'] = $('#RA_Password')[0].value;
...
//alert( 'error 1 ('+ RA_CtrlWin.RAWS_iUserID +') --- '+ RA_CtrlWin.RAWS_error );
		...
		RA_DrawPage();
		$('#RA_formError_login').css('display','block');
...
function RA_doEmailPassword () {
	...
	if (RA_CtrlWin.RA.RAif.vars['Email']=='') {
		...
		if (document.getElementById('RA_Email_error')) {
			...
			$('#RA_formError_emailpassword').css('display','block');
		}
		return;
	}
	RA_EmailPassword();
...
function RA_goEmailPassword () {
	if (document.getElementById('RA_Email_error')) {
		...
		$('#RA_formError_emailpassword').css('display','none');
	}
	if ($('#RA_Email')[0].value=='') {
		RA_CtrlWin.RA.RAif.vars['Error'] = 'Enter your e-mail address.';
		if (document.getElementById('RA_Email_error')) {
...
function RA_goCheckEmail () {
	if (document.getElementById('RA_Email_error')) {
		...
		$('#RA_formError_checkemail').css('display','none');
	}
	if ($('#RA_Email')[0].value=='') {
		...
		if (document.getElementById('RA_Email_error')) {
			...
			$('#RA_formError_checkemail').css('display','block');
		}
		return;
	}
	RA_CtrlWin.RA.RAif.vars['Email'] = $('#RA_Email')[0].value;
...
function RA_goCheckEmailANDLogin () {
	if (document.getElementById('RA_Email_error')) {
		...
		$('#RA_formError_checkandemail').css('display','none');
	}
	$('#RA_formError_checkemailandlogin').css('display','none');
	$('#RA_formError_checkemailandlogin').css('color','#000');
	if ($('#RA_EmailLOGIN')[0].value=='' || $('#RA_EmailLOGIN')[0].value=='e-mail address') {
		$('#RA_Email_error').css('color','#f00');
		return;
	}
	RA_CtrlWin.RA.RAif.vars['Email'] = $('#RA_EmailLOGIN')[0].value;
	if ($('#RA_Password')[0].value == '') {
		RA_CtrlWin.RA.RAif.vars['Error'] = 'Please enter your password to log in.';
		$('#RA_formError_checkemailandlogin').css('color','#f00');
		$('#RA_formError_checkemailandlogin').css('display','block');
		return;
	}
	RA_CtrlWin.RA.RAif.vars['Password'] = $('#RA_Password')[0].value;
...
//alert( 'error 1 ('+ RA_CtrlWin.RAWS_iUserID +') --- '+ RA_CtrlWin.RAWS_error );
		...
		RA_DrawPage();
		$('#RA_formError_checkemailandlogin').css('display','block');
		$('#RA_formError_checkemailandlogin').html(RA_CtrlWin.RA.RAif.vars['Error']);
		RAif_Resize();
//window.self.focus();
//		window.document.location = 'RAif.html';
	} else if ( RA_CtrlWin.RAWS_error=='That e-mail address is registered with a different password. Please enter valid password.' ) {
...
function RA_goCheckEmailLogin () {
	$('#RA_formError_checkemaillogin').css('display','none');
	$('#RA_formError_checkemaillogin').css('color','#000');
	if ($('#RA_Password')[0].value == '') {
		RA_CtrlWin.RA.RAif.vars['Error'] = 'Please enter your password to log in.';
		$('#RA_formError_checkemaillogin').css('color','#f00');
		$('#RA_formError_checkemaillogin').css('display','block');
		return;
	}
	RA_CtrlWin.RA.RAif.vars['Password'] = $('#RA_Password')[0].value;
	RA_CheckEmailLogin();
...
//	RA_CtrlWin.RA.RAif.vars['Email'] = $('#RA_Email')[0].value;
	RA_CtrlWin.RA.RAif.vars['Email_confirm'] = $('#RA_Email_confirm')[0].value;
	RA_CtrlWin.RA.RAif.vars['FName'] = $('#RA_FName')[0].value;
	RA_CtrlWin.RA.RAif.vars['LName'] = $('#RA_LName')[0].value;
	RA_CtrlWin.RA.RAif.vars['Password'] = $('#RA_Password')[0].value;
	RA_CtrlWin.RA.RAif.vars['Password_confirm'] = $('#RA_Password_confirm')[0].value;

	var xHint = $('#RA_Password')[0].value;
	...
	$('#RA_formError_register').css('display','none');
	RA_CtrlWin.RA.RAif.vars['Error'] = '';
	$('#RA_FName_error').css('display','none');
	$('#RA_LName_error').css('display','none');
	$('#RA_Password_error').css('display','none');
	$('#RA_Email_confirm_error').css('display','none');
	$('#RA_Password_confirm_error').css('display','none');
	if (RA_CtrlWin.RA.RAif.vars['FName']=='') {
		RA_CtrlWin.RA.RAif.vars['Error'] = 'All fields are required. Please fill them all in.';
		$('#RA_FName_error').css('display','block');
	}
	if (RA_CtrlWin.RA.RAif.vars['LName']=='') {
		RA_CtrlWin.RA.RAif.vars['Error'] = 'All fields are required. Please fill them all in.';
		$('#RA_LName_error').css('display','block');
	}
	if (RA_CtrlWin.RA.RAif.vars['Email_confirm']=='') {
		RA_CtrlWin.RA.RAif.vars['Error'] = 'All fields are required. Please fill them all in.';
		$('#RA_Email_confirm_error').css('display','block');
	}
	if (RA_CtrlWin.RA.RAif.vars['Password']=='') {
		RA_CtrlWin.RA.RAif.vars['Error'] = 'All fields are required. Please fill them all in.';
		$('#RA_Password_error').css('display','block');
	}
	if (RA_CtrlWin.RA.RAif.vars['Password_confirm']=='') {
		RA_CtrlWin.RA.RAif.vars['Error'] = 'All fields are required. Please fill them all in.';
		$('#RA_Password_confirm_error').css('display','block');
	}
	if (RA_CtrlWin.RA.RAif.vars['Error']!='') {
		$('#RA_formError_register').html(RA_CtrlWin.RA.RAif.vars['Error']);
		$('#RA_formError_register').css('display','block');
		RAif_Resize();
//window.self.focus();
		return;
	}
...
function RA_goCheckCode () {
	...
	RA_CtrlWin.RA.RAif.vars['Code'] = $('#RA_Code')[0].value;
	if (RA_CtrlWin.RA.RAif.vars['Code']=='') {
		...
		$('#RA_formError_checkcode').css('display','block');
...
//alert(RA_CtrlWin.RAWS_iPackageID +' - '+ RA_CtrlWin.RA.Packages[RA_CtrlWin.RAWS_iPackageID]);
		...
		RA_DrawPage();
		$('#RA_formError_assignusercodes').css('display','block');
...
function RA_BackToCart () {
	...
	if (RA_CtrlWin.RA.RAif.vars['Error'] && RA_CtrlWin.RA.RAif.vars['Error'] != '') {
		$('#RA_formError_cart').css('display','block');
	}
	RAif_Resize();
//window.self.focus();
}
...
function RA_goCheckOutLookupSchool () {
	if (RA_CtrlWin.RA.RAif.vars['Schools'].length == 0) {
		...
		if (w.selectedIndex == -1) {
			...
			$('#RA_formError_checkoutschoolprompt').css('display','block');
			RAif_Resize();
//window.self.focus();
			return;
		}
...
//window.self.focus();
	...
	var z = new Number( $('#RA_iZip')[0].value.replace('-','') );
	if (isNaN(z)) {
...
//window.self.focus();
	...
	RA_CtrlWin.RA.RAif.vars['iZip'] = $('#RA_iZip')[0].value.replace('-','');
...
function RA_doChangeEmail () {
	$('#RA_editLogin').css('display','block');
	$('#RA_editEmail').css('display','block');
	$('#RA_showEmail').css('display','none');
...
function RA_doChangePw () {
	$('#RA_editLogin').css('display','block');
	$('#RA_changePw').css('display','block');
	$('#RA_showPw').css('display','none');
	RA_ChangingPw=true;
	RAif_Resize();
//window.self.focus();
}
...
function RA_goUpdateProfile () {
	...
	$('#RA_formError_updateprofile').css('display','none');
	$('#RA_sUserFirstName_error').css('display','none');
	$('#RA_sUserLastName_error').css('display','none');
	$('#RA_sUserEmail_error').css('display','none');
	$('#RA_sUserEmail_confirm_error').css('display','none');
	$('#RA_sOldPwd_error').css('display','none');
	$('#RA_sNewPwd_error').css('display','none');
	$('#RA_sVPwd_error').css('display','none');
	if ($('#RA_sUserFirstName')[0].value == '') {
		...
		$('#RA_formError_updateprofile').css('display','block');
		$('#RA_sUserFirstName_error').css('display','block');
		RAif_Resize();
//window.self.focus();
		return;
	}
	if ($('#RA_sUserLastName')[0].value == '') {
		...
		$('#RA_formError_updateprofile').html(RA_CtrlWin.RA.RAif.vars['Error']);
		$('#RA_formError_updateprofile').css('display','block');
		$('#RA_sUserLastName_error').css('display','block');
		RAif_Resize();
//window.self.focus();
		return;
	}
	if (RA_ChangingEmail && $('#RA_sUserEmail')[0].value == '') {
		...
		$('#RA_formError_updateprofile').html(RA_CtrlWin.RA.RAif.vars['Error']);
		$('#RA_formError_updateprofile').css('display','block');
		$('#RA_sUserEmail_error').css('display','block');
		RAif_Resize();
//window.self.focus();
		return;
	}
	if (RA_ChangingEmail && $('#RA_sUserEmail')[0].value != $('#RA_sUserEmail_confirm')[0].value) {
		...
		$('#RA_formError_updateprofile').html(RA_CtrlWin.RA.RAif.vars['Error']);
		$('#RA_formError_updateprofile').css('display','block');
		$('#RA_sUserEmail_confirm_error').css('display','block');
		RAif_Resize();
//window.self.focus();
		return;
	}
	if (RA_ChangingPw && $('#RA_sOldPwd')[0].value == '') {
		...
		$('#RA_formError_updateprofile').html(RA_CtrlWin.RA.RAif.vars['Error']);
		$('#RA_formError_updateprofile').css('display','block');
		$('#RA_sOldPwd_error').css('display','block');
		RAif_Resize();
//window.self.focus();
		return;
	}
	if (RA_ChangingPw && $('#RA_sNewPwd')[0].value == '') {
		...
		$('#RA_formError_updateprofile').html(RA_CtrlWin.RA.RAif.vars['Error']);
		$('#RA_formError_updateprofile').css('display','block');
		$('#RA_sNewPwd_error').css('display','block');
		RAif_Resize();
//window.self.focus();
		return;
	}
	if (RA_ChangingPw && $('#RA_sNewPwd')[0].value != $('#RA_sVPwd')[0].value) {
		...
		$('#RA_formError_updateprofile').html(RA_CtrlWin.RA.RAif.vars['Error']);
		$('#RA_formError_updateprofile').css('display','block');
		$('#RA_sVPwd_error').css('display','block');
		RAif_Resize();
//window.self.focus();
		return;
	}
	...
	RA_CtrlWin.RA.RAif.vars['sUserEmail'] = $('#RA_sUserEmail')[0].value;
	RA_CtrlWin.RA.RAif.vars['sInstructorEmail'] = '';
	RA_CtrlWin.RA.RAif.vars['sUserFirstName'] = $('#RA_sUserFirstName')[0].value;
	RA_CtrlWin.RA.RAif.vars['sUserLastName'] = $('#RA_sUserLastName')[0].value;
...
//	RA_CtrlWin.RA.RAif.vars['sOptInEmail'] = 0;
	...
	RA_CtrlWin.RA.RAif.vars['sUserName'] = $('#RA_sUserEmail')[0].value;
	RA_CtrlWin.RA.RAif.vars['sOldPwd'] = $('#RA_sOldPwd')[0].value;
	RA_CtrlWin.RA.RAif.vars['sNewPwd'] = $('#RA_sNewPwd')[0].value;
	RA_CtrlWin.RA.RAif.vars['sVPwd'] = $('#RA_sVPwd')[0].value;
	var xHint = $('#RA_sNewPwd')[0].value;
	xHint = xHint.substring(0,1) +' '+ xHint.substring(1,xHint.length-2) +' '+  xHint.substring(xHint.length-2);
	RA_CtrlWin.RA.RAif.vars['sHintPwd'] = xHint;
	RA_UpdateProfile();
}
...
//alert(RA_CtrlWin.RA.RAif.vars['sInstructorEmail'] +' --- '+ $('#RA_sInstructorEmail')[0].value);
	RA_CtrlWin.RA.RAif.vars['sInstructorEmail'] = $('#RA_sInstructorEmail')[0].value;
...
//alert( 'error 0 ('+ RA_CtrlWin.RAWS_iUserID +') --- '+ RA_CtrlWin.RAWS_error );
		...
		RA_CtrlWin.RA.RAif.vars['Error'] = RA_CtrlWin.RAWS_error;
		RA_DrawPage();
		$('#RA_formError_quizprompt').css('display','block');
...
function RA_QuizClassPrompt1Yes () {
	...
	case 0 :
		$('#RA_quizclassprompt_1').css('display','none');
		$('#RA_quizclassprompt_2').css('display','block');
		$('#RA_quizclassprompt_3').css('display','none');
		$('#RA_quizclassprompt_4').css('display','none');
		RAif_Resize();
//window.self.focus();
	...
	case 1 :
		...
		$('#RA_quizclassprompt_2').css('display','none');
		$('#RA_quizclassprompt_3').css('display','none');
		$('#RA_quizclassprompt_4').css('display','block');
		RAif_Resize();
//window.self.focus();
		break;
	default :
...
function RA_goQuizJoinClass () {
	RA_CtrlWin.RA.RAif.vars['sClassCode'] = $('#RA_sClassCode')[0].value;
	RA_QuizJoinClass();
}
...
//prompt('',RA_CtrlWin.RAWS_error);
	if ( RA_CtrlWin.RAWS_error=='' ) {
		...
		if ( RA_CtrlWin.RAWS_error == 'SOME ERROR TO CATCH.') {
			...
			$('#RA_quizclassprompt_3').css('display','none');
			$('#RA_quizclassprompt_4').css('display','none');
			$('#RA_formError_quizclassprompt').css('display','block');
