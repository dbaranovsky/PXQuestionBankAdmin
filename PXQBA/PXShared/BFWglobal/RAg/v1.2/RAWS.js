...
'</soap:Envelope>' + 
''
//if (RA_CtrlWin.RA.dev_check()) prompt('RAWS3_GetSiteFromBaseURL_WithProducts',strEnvelope);
...
/*
			xEl = nSs[iS].getElementsByTagName('sDescription')[0];
			for (var i=0; i<xEl.childNodes.length; i++) {
