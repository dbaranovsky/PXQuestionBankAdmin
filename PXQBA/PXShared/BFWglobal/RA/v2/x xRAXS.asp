...
responseStr = responseStr&"var RAXSok = false"& VBCRLF
responseStr = responseStr&"try{var x = RA_CtrlWin;RAXSok=true}catch(e){}if(!RAXSok){try{alert(window.parent);RA_CtrlWin=window.parent;RAXSok=true}catch(e){}}"& VBCRLF
'"
responseStr = responseStr&"if(RAXSok) {"& VBCRLF
...
debugWrite "", ""
debugWrite "X-Site ?", Request.QueryString("rau") &" - "& Request.Cookies("RAUserID") &" - "& Request.Cookies("RAUserProfile")
debugWrite "", ""

''if Request.Cookies("RAUserProfile") = "" then
''if Request.QueryString("returned") <> "true" then
	dim oldXSreturl
...
responseStr = responseStr &"RA_CtrlWin.RAXSInitialized = true;"& VBCRLF
responseStr = responseStr &"//alert('2: '+RA_CtrlWin.RAXSInitialized);"& VBCRLF
responseStr = responseStr &"} alert(RAXSok); //RAXSok"& VBCRLF
Response.Write responseStr
