...
dim rsObj
%>
<!--#include virtual="/BFWglobal/RA/server/v1/xxx-connect-ra.asp"-->
<!--#include virtual="/BFWglobal/RA/server/v1/xxx-adovbs.asp"-->
<%
dim strQuery
dim RS_Site_ct
dim RS_lastSiteID
...
"  <soap:Body>" &_
"    <GetSiteFromBaseURL xmlns=""http://tempuri.org/"">" &_
"      <sBaseURL>192.168.77.245/apvtk</sBaseURL>      <sBaseURL>192.168.77.245/apvtk/</sBaseURL>" &_
"    </GetSiteFromBaseURL>" &_
"  </soap:Body>" &_
"</soap:Envelope>" &_
""
...
''				arrProduct(udtProduct__sBaseURL) = rsObj("BaseURL")
			...
			case "RA CONTENT"
call writeMsg ("is RA CONTENT","yep")
''				arrProduct(udtProduct__sBaseURL) = rsObj("BaseURL")
				sSiteIDs = sSiteIDs & ","
				sSiteIDs = sSiteIDs & arrProduct(udtProduct__sProductID)
			case else
