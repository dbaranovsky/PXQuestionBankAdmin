...
' **********************************************************************
' INCLUDE FOR ExactTarget
' Added by Chad 2008/8/15
' **********************************************************************
%>
<!--#include virtual="/BFWglobal/ExactTarget/ASP/ExactTarget.inc"-->
<%

dim DoExactTarget : DoExactTarget = true
...
"      <iUserID>4241988</iUserID>" &_
"    </RAXS_WS>" &_
"  </soap:Body>" &_
"</soap:Envelope>" &_
""
''"      <iUserID>4241961</iUserID>" &_
end if
...
dim RACU_iUserID, RACU_sUserName, RACU_sFirstName, RACU_sLastName, RACU_sPasswordHint, RACU_sMailPreference, RACU_sOptInEmail, RACU_iGUID
...
' **********************************************************************
' START ExactTarget
' Added by Chad 2008/8/25
' **********************************************************************
if DoExactTarget or Request.Querystring("debug") = "true" then

ET_sOutputStatus = ET_RetrieveUser( RACU_sUserName )

debugWrite "x", "ET_RetrieveUser('"& RACU_sUserName &"')<br/>"
debugWrite "x", "ET_RetrieveUser ET_sOutputStatus :: "& ET_sOutputStatus &"<br/><br/>"

if ET_sOutputStatus="Active" then

	RACU_sOptInEmail = "True"

elseif ET_sOutputStatus="Unsubscribed" then

	RACU_sOptInEmail = "False"

else

'DO NOTHING, USE RAWS OUTPUT FOR OPTINEMAIL
'	RACU_sOptInEmail = "False"
...
responseStr = responseStr & "<iGUID>"& RACU_iGUID &"</iGUID>"
responseStr = responseStr & "</udtUserProfile>"
	...
	Else
		while not rsObj.EOF
			...
			if RA_UserCt = 1 then
				...
				RACU_sUserName = XMLescape( rsObj("UserEmail") )
				RACU_sFirstName = XMLescape( rsObj("FirstName") )
				RACU_sLastName = XMLescape( rsObj("LastName") )
				RACU_sPasswordHint = XMLescape( rsObj("PasswordHint") )
				RACU_sMailPreference = XMLescape( rsObj("MailPreferences") )
				RACU_sOptInEmail = rsObj("OptInEmail")
				RACU_iGUID = rsObj("GUID")
