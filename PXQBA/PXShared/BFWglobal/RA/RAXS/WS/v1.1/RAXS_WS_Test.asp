...
set resultXML = Server.CreateObject("Microsoft.XMLDOM")
dim ET_sOptInEmail : ET_sOptInEmail = "False"
...
"      <Email__Address>"& RACU_sUserName &"</Email__Address>"&_
"    </RetrieveUser>"&_
"  </soap:Body>"&_
"</soap:Envelope>"&_
""
	...
	RACU_sOptInEmail = ET_sOptInEmail
...
debugWrite "x", "ET User Status :: "& ET_StatusMessage.text &VBCRLF
	if ET_StatusMessage.text = "Active" then
		ET_sOptInEmail = "True"
	end if
