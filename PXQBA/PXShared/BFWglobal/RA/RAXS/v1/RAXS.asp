...
if not referrerAuthenticated then
	response.write "alert('invalid RAXS referrer')"
	response.end
end if
...
debugWrite "sSiteIDs", sSiteIDs
	...
	strQuery = "EXEC raxs_getSitePackAssignmentsFromIds @siteids='"& sSiteIDs &"'"
...
debugWrite "sPackageIDs", sPackageIDs
	...
	strQuery = "EXEC raxs_getPackBatchesFromIds @packageids='"& sPackageIDs &"'"
