...
popInWindowHTML = '<style type="text/css">'
	+ '.popInWindowS {visibility:hidden; position:absolute; z-index:20000; left:20; top:20; background: url("images/settingsbox-left.png") no-repeat top left; width:300px}'
	...
	+ '.popInTitleS {font-size:11px; font-family:Verdana, sans-serif; background: #434343 url("images/settingsbox-headbg.gif") repeat-x bottom left; padding: 6px 10px; color:#fff; text-transform:uppercase; white-space:nowrap; cursor:move}'
	+ 'a.popInCloseLinkS {float:right; width:13px; height:0; padding-top:13px; overflow:hidden; background: url("images/settingsbox-close.gif") no-repeat; cursor:pointer}'
	+ '</style>'
...
function MovePopInIntoWindow() {
	...
	if ((popLeft + popWidth) > windowWidth) {
		ShiftPopInWindow(windowWidth - popWidth, -1, 'absolute');
...
function PopIn_findPos(obj) {
	...
	// get offsetHeight and width too
