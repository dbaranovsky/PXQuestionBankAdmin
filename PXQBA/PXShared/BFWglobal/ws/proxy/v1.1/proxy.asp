...
''	RARootDomain = "bcs.bfwpub.com"
	RAVellRootDomain = "qa.idp.bfwpub.com"
...
elseif inStr(Request.ServerVariables("HTTP_HOST"),"stg.") = 1 then
	RARootDomain = "stg.bfwpub.com/BFWglobal/_tempraws3"
	RAVellRootDomain = "stg.idp.bfwpub.com"
	if wsID = "RAWS3" then
		RARootDomain = "stg-raws.bfwpub.com"
	elseif wsID = "IL_CheckInstructorAccess" then
		RARootDomain = "stg-raws.bfwpub.com"
	end if
elseif inStr(Request.ServerVariables("HTTP_HOST"),"qa.") = 1 then
...
elseif inStr(Request.ServerVariables("HTTP_HOST"),"dev.") = 1 OR inStr(Request.ServerVariables("HTTP_HOST"),"ravell.px.") = 1 then
	RARootDomain = "int-bcs.bfwpub.com"
	RAVellRootDomain = "dev.idp.bfwpub.com:8080"
	if wsID = "RAWS3" then
		RARootDomain = "int-raws.bfwpub.com"
	elseif wsID = "IL_CheckInstructorAccess" then
		RARootDomain = "int-raws.bfwpub.com"
...
elseif inStr(Request.ServerVariables("HTTP_HOST"),"stg-") = 1 then
	...
	RARootDomain = "bcs.bfwpub.com"
	RAVellRootDomain = "idp.bfwpub.com"
	if wsID = "RAWS3" then
...
Response.AddHeader "RAPostTarget", RARootDomain
Response.AddHeader "RavellPostTarget", RAVellRootDomain
...
"<soap:Envelope xmlns:xsi=""http://tempuri.org/"" xmlns:xsd=""http://www.w3.org/2001/XMLSchema"" xmlns:soap=""http://schemas.xmlsoap.org/soap/envelope/"">  <soap:Body>    <RAXS_WS xmlns=""http://tempuri.org/"">      <iUserID>156</iUserID>    </RAXS_WS>  </soap:Body></soap:Envelope>"
		...
		case "Ravell"
			wsURL = "http://"& RAVellRootDomain &"/nidp/app/login?id=emlogin&target=http://no.target"
			strEnvelope = "Ecom_User_ID="& Request.QueryString("Ecom_User_ID") &"&Ecom_Password="& Request.QueryString("Ecom_Password") &"&option=credential"
