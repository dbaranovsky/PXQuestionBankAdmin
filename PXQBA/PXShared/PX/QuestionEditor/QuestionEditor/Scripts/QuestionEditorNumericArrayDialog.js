...
//
(function ($) {
    window.QuestionEditorNumericArrayDialog = function () {
        var _static = {
            varTypes: {
                inMode: "new"
            },
            varOldName: "",
            sel: {
                variableDialog: ".hts-numeric-array-dialog",
                variableDialogForm: ".hts-numeric-array-dialog form",
                variableDialogFormErrors: ".hts-numeric-array-dialog form .errors",
                variableDialogFormInputs: ".hts-numeric-array-dialog .form input",

                saveButton: ".hts-numeric-array-dialog .save-array-button",
                cancelButton: ".hts-numeric-array-dialog .cancel-array-button",
                variableList: ".hts-numeric-array-dialog .hts-variable-list",
                variableRows: ".hts-numeric-array-dialog .hts-variable-row",
                variableRowTemplate: ".hts-numeric-array-dialog .hts-variable-row-template",
                variableRowAddButton: '.hts-numeric-array-dialog .add-array-value-button',
                variableRowEditButtons: '.hts-numeric-array-dialog .hts-variable-row .hts-variable-edit',
                variableRowDeleteButtons: '.hts-numeric-array-dialog .hts-variable-row .hts-variable-delete',
                variableRowSaveButtons: '.hts-numeric-array-dialog .hts-variable-row .hts-variable-save',
                variableRowCancelButtons: '.hts-numeric-array-dialog .hts-variable-row .hts-variable-cancel',
            ...
            fn: {
                preload: function (variable) {
                    ...
                    dialog.find(_static.sel.variableDecimalPlacesInput).val(variableFormat);
        ...
        return {
            ...
            static: function (pluginStatic) {
                ...
                return {
                    sel: {
                    //                        numericVariableDialog: ".hts-numeric-array-dialog",                        
                },
                fn: {
                    loadNumericArrayDialog: function (variable) {
                        _static.fn.load(variable);
                    },
                    saveNumericArrayDialog: function () {
