...
<div class="hts-text-variable-dialog hts-side-dialog">
<form action="">
    <div class="header">
        <span>Editing Text Variable</span></div>
    <div class="form">
                ...
                <div class="body">
                    <ul>
                        ...
                        <li class="hts-variable-pool-values-inputs">
                            String <input type="text" class="hts-variable-pool-values required" name="hts-variable-string" />
                            <div class="helper-button">
                            </div>
                            <div class="clearer" />
                        </li>
