...
html4.ATTRIBS = {
    ...
    //'class': html4.atype.NMTOKENS,// unsafe
...
var html = (function(html4) {
  ...
  function makeHtmlSanitizer(tagPolicy) {
    ...
    return makeSaxParser({
      ...
      'startTag': function(tagNameOrig, attribs, out) {
        if (ignoring) { return; }
        if (!html4.ELEMENTS.hasOwnProperty(tagNameOrig)) { throw { vaule: -1, message:"Cannot contain unsupported html tag" }; }
      ...
      'endTag': function(tagName, out) {
        ...
        if (!html4.ELEMENTS.hasOwnProperty(tagName)) { throw { vaule: -1, message: "Cannot contain unsupported html tag" }; }
        var eflags = html4.ELEMENTS[tagName];
  ...
  function safeUri(uri, effect, ltype, hints, naiveUriRewriter) {
    if (!naiveUriRewriter) { return uri; }
    try {
  ...
  function sanitizeAttribs(tagName, attribs,
    ...
    for (var i = 0; i < attribs.length; i += 2) {
      ...
      if (html4.ATTRIBS.hasOwnProperty(attribName)) {
          atype = html4.ATTRIBS[attribName];
      }
      if (atype !== null) {
        switch (atype) {
          ...
          case html4.atype['SCRIPT']:
            ...
            throw { vaule: -2, message: "Cannot contain unsupported html attribute" };
            break;
