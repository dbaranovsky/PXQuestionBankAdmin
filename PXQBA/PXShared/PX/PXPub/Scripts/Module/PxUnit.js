    ...
    return {
        ...
        OnClickSave: function (OnSuccess) {
            ...
            if (PxPage.ValidateTitle(true)) {
                ...
                PxPage.OnFormSubmit('Processing...', true, { form: '#saveItem', data: { behavior: 'Save' },
                    rules: { imageUrl: { required: '#imageUrl:filled', regex: RegExp }
                    },
        ...
        SaveImageSrc: function () {
            $('#Content_Thumbnail').val($('.unitImage').attr('src'));
        },
