        ...
        return (
            <div>
              <div className="dropdown">
                    <div className="add-column-container" data-toggle="tooltip" title="Add filter">
                        <span data-toggle="dropdown" className="dropdown-toggle add-column-button">  <span className="icon-plus"></span> </span>
